...
public class LangAdapter extends RecyclerView.Adapter<LangAdapter.CountryViewHolder> {
    ...
    public void onBindViewHolder(CountryViewHolder holder, int position) {
        ...
        holder.binding.nameTxt.setText(languageModel.getUserName().trim());

        if (languageModel.getUserId() == selectedPosition) {
    ...
    public class CountryViewHolder extends RecyclerView.ViewHolder {
        ...
        CountryViewHolder(RowLangItemBinding view) {
            ...
            itemView.setOnClickListener(v -> {
                ...
                selectedPosition = langList.get(getAdapterPosition()).getUserId();
