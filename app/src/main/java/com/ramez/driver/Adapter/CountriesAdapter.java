...
import com.ramez.driver.databinding.RowItemCityBinding;
...
public class CountriesAdapter extends RecyclerView.Adapter<CountriesAdapter.CountryViewHolder> {
    ...
    public void onBindViewHolder(CountryViewHolder holder, int position) {
        CountryModel countryModel = countryModels.get(position);
            holder.binding.textCountry.setText(countryModel.getUserName());
            holder.binding.imgFlag.setImageResource(countryModel.getFlag());

        if (selectedPosition==countryModel.getUserId()) {
    ...
    public class CountryViewHolder extends RecyclerView.ViewHolder {
        ...
        CountryViewHolder(RowItemCityBinding view) {
            ...
            itemView.setOnClickListener(v -> {
                ...
                selectedPosition = countryModels.get(getAdapterPosition()).getUserId();
